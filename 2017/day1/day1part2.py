...
for element in list_elements:
    ...
    if it < length_list - 1 and next_it < length_list - 1:
        list_matches = check_match(list_elements[it], list_elements[next_it])

    elif it < length_list - 1 <= next_it:
        difference = next_it - (length_list - 1)
        print('difference is:', difference)
        list_matches = check_match(list_elements[it], list_elements[difference - 1])
        ...
        list_matches = check_match(list_elements[it], list_elements[0 + int(step) - 1])
